...
import {
  ...
  CountVar,
  LikeButton,
} from "style/components/CommentLikeStyle";

const CommentAndLike = ({ comments, likes }: { comments: any; likes: any }) => {
  return (
    <ChatContainer>
      <LikeButton>
        <svg width="35" height="35" viewBox="0 0 24 24" aria-label="clap">
        ...
        </svg><CountVar>{comments.length}</CountVar>
      </LikeButton>
      ...
      <LikeButton>
        ...
        <CountVar>{likes.length}</CountVar>
      </LikeButton>
    </ChatContainer>
  );
};
